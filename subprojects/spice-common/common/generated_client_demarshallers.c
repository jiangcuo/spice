...
static uint8_t * parse_msg_migrate(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
...
static uint8_t * parse_msg_set_ack(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_ping(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_wait_for_channels(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint64_t mem_size;
    uint8_t *in, *end;
    uint64_t wait_list__nw_size, wait_list__mem_size;
    uint64_t wait_list__nelements;
...
static uint8_t * parse_msg_disconnecting(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_notify(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_main_migrate_begin(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint64_t dst_info__extra_size;
    SpiceMsgMainMigrationBegin *out;
    uint32_t i;

    { /* dst_info */
        SPICE_GNUC_UNUSED uint8_t *start2 = (start + 0);
        uint64_t dst_info_host_data__extra_size;
        uint64_t dst_info_host_data__array__nelements;
        uint64_t dst_info_cert_subject_data__extra_size;
        uint64_t dst_info_cert_subject_data__array__nelements;
        { /* host_data */
            uint32_t host_data__value;
            uint64_t dst_info_host_data__array__nw_size;
            uint64_t dst_info_host_data__array__mem_size;
            ...
            if (SPICE_UNLIKELY(host_data__value >= (uintptr_t) (message_end - message_start))) {
                goto error;
            }
            pos = start2 + 4;
            if (SPICE_UNLIKELY(pos + 4 > message_end)) {
            ...
            if (SPICE_UNLIKELY(host_data__value + dst_info_host_data__array__nw_size > (uintptr_t) (message_end - message_start))) {
                goto error;
            }
        ...
        { /* cert_subject_data */
            ...
            uint64_t dst_info_cert_subject_data__array__nw_size;
            uint64_t dst_info_cert_subject_data__array__mem_size;
            ...
            if (SPICE_UNLIKELY(cert_subject_data__value >= (uintptr_t) (message_end - message_start))) {
                goto error;
            }
            pos = start2 + 12;
            if (SPICE_UNLIKELY(pos + 4 > message_end)) {
            ...
            if (SPICE_UNLIKELY(cert_subject_data__value + dst_info_cert_subject_data__array__nw_size > (uintptr_t) (message_end - message_start))) {
                goto error;
            }
    ...
    /* dst_info */ {
        uint64_t host_data__array__nelements;
        uint64_t cert_subject_data__array__nelements;
...
static uint8_t * parse_msg_main_init(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_main_mouse_mode(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_main_multi_media_time(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_main_agent_disconnected(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_main_agent_token(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_main_migrate_switch_host(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint32_t n_ptr=0;
    PointerInfo ptr_info[2];
    uint64_t host_data__extra_size;
    uint64_t host_data__array__nelements;
    uint64_t cert_subject_data__extra_size;
    uint64_t cert_subject_data__array__nelements;
    ...
    { /* host_data */
        uint32_t host_data__value;
        uint64_t host_data__array__nw_size;
        uint64_t host_data__array__mem_size;
        uint32_t host_size__value;
        pos = (start + 8);
        if (SPICE_UNLIKELY(pos + 4 > message_end)) {
            goto error;
        ...
        if (SPICE_UNLIKELY(host_data__value + host_data__array__nw_size > (uintptr_t) (message_end - message_start))) {
            goto error;
        }
    ...
    { /* cert_subject_data */
        uint32_t cert_subject_data__value;
        uint64_t cert_subject_data__array__nw_size;
        uint64_t cert_subject_data__array__mem_size;
        uint32_t cert_subject_size__value;
        pos = (start + 16);
        if (SPICE_UNLIKELY(pos + 4 > message_end)) {
            goto error;
        ...
        if (SPICE_UNLIKELY(cert_subject_data__value + cert_subject_data__array__nw_size > (uintptr_t) (message_end - message_start))) {
            goto error;
        }
...
static uint8_t * parse_msg_main_name(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_main_uuid(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_main_agent_connected_tokens(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_main_migrate_begin_seamless(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_mode(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_struct_SpiceClipRects(uint8_t *message_start, SPICE_GNUC_UNUSED uint8_t *message_end, uint8_t *struct_data, PointerInfo *this_ptr_info)
{
    uint8_t *in = message_start + this_ptr_info->offset;
    uint8_t *end;
    SpiceClipRects *out;
    uint64_t rects__nelements;
    uint32_t i;
...
static uint8_t * parse_msg_display_copy_bits(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint64_t base__nw_size, base__extra_size;
    ...
    { /* base */
        SPICE_GNUC_UNUSED uint8_t *start2 = (start + 0);
        uint64_t base_clip__nw_size, base_clip__extra_size;
        { /* clip */
            SPICE_GNUC_UNUSED uint8_t *start3 = (start2 + 20);
            uint64_t base_clip_u__nw_size, base_clip_u__extra_size;
            uint8_t type__value;
            { /* u */
                uint64_t base_clip_u__mem_size;
                pos = start3 + 0;
                if (SPICE_UNLIKELY(pos + 1 > message_end)) {
                    goto error;
                }
                ...
                if (type__value == SPICE_CLIP_TYPE_RECTS) {
                    ...
                    uint64_t base_clip_u_rects__nw_size, base_clip_u_rects__mem_size;
                    uint64_t base_clip_u_rects__nelements;
                    { /* rects */
...
static uint8_t * parse_msg_display_inval_list(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint64_t mem_size;
    uint8_t *in, *end;
    uint64_t resources__nw_size, resources__mem_size;
    uint64_t resources__nelements;
...
static uint8_t * parse_msg_display_inval_all_pixmaps(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_inval_palette(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_stream_create(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint32_t n_ptr=0;
    PointerInfo ptr_info[1];
    uint64_t clip__nw_size, clip__extra_size;
    uint32_t rects__saved_size = 0;
    ...
    { /* clip */
        ...
        uint64_t clip_u__nw_size, clip_u__extra_size;
        uint8_t type__value;
        { /* u */
            uint64_t clip_u__mem_size;
            pos = start2 + 0;
            if (SPICE_UNLIKELY(pos + 1 > message_end)) {
                goto error;
            }
            ...
            if (type__value == SPICE_CLIP_TYPE_RECTS) {
                ...
                uint64_t clip_u_rects__nw_size, clip_u_rects__mem_size;
                uint64_t clip_u_rects__nelements;
                { /* rects */
                    uint32_t num_rects__value;
                    pos = start3 + 0;
                    if (SPICE_UNLIKELY(pos + 4 > message_end)) {
...
static uint8_t * parse_msg_display_stream_data(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_stream_clip(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_stream_destroy(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static intptr_t validate_SpicePalette(uint8_t *message_start, uint8_t *message_end, uint64_t offset)
{
    uint8_t *start = message_start + offset;
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint64_t mem_size, nw_size;
    uint64_t ents__nw_size, ents__mem_size;
    uint64_t ents__nelements;
    ...
    if (SPICE_UNLIKELY(nw_size > (uintptr_t) (message_end - start))) {
        goto error;
    }
    return mem_size;
...
static intptr_t validate_SpiceImage(uint8_t *message_start, uint8_t *message_end, uint64_t offset)
{
    uint8_t *start = message_start + offset;
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint64_t mem_size, nw_size;
    SPICE_GNUC_UNUSED intptr_t ptr_size;
    uint64_t u__nw_size, u__extra_size;
    ...
    { /* u */
        ...
        if (descriptor_type__value == SPICE_IMAGE_TYPE_BITMAP) {
            ...
            uint64_t u_pal__nw_size, u_pal__extra_size;
            uint8_t flags__value;
            uint64_t u_data__nw_size, u_data__extra_size;
            uint64_t u_data__nelements;
            { /* pal */
                pos = start2 + 1;
                if (SPICE_UNLIKELY(pos + 1 > message_end)) {
                    goto error;
                ...
                if ((flags__value & SPICE_BITMAP_FLAGS_PAL_FROM_CACHE)) {
                    ...
                    ptr_size = validate_SpicePalette(message_start, message_end, u_pal_palette__value);
            ...
            { /* data */
                ...
                u_data__nelements = (uint64_t) stride__value * y__value;
...
static uint8_t * parse_struct_SpicePalette(uint8_t *message_start, SPICE_GNUC_UNUSED uint8_t *message_end, uint8_t *struct_data, PointerInfo *this_ptr_info)
{
    uint8_t *in = message_start + this_ptr_info->offset;
    uint8_t *end;
    SpicePalette *out;
...
static uint8_t * parse_struct_SpiceImage(uint8_t *message_start, SPICE_GNUC_UNUSED uint8_t *message_end, uint8_t *struct_data, PointerInfo *this_ptr_info)
{
    uint8_t *in = message_start + this_ptr_info->offset;
    uint8_t *end;
    SPICE_GNUC_UNUSED intptr_t ptr_size;
    ...
    if (out->descriptor.type == SPICE_IMAGE_TYPE_BITMAP) {
        ...
        data__nelements = ((uint64_t) out->u.bitmap.stride * out->u.bitmap.y);
        /* use array as chunk */
...
static uint8_t * parse_msg_display_draw_fill(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint64_t base__nw_size, base__extra_size;
    uint32_t rects__saved_size = 0;
    uint64_t data__nw_size, data__extra_size;
    ...
    { /* data */
        ...
        uint64_t data_brush__nw_size, data_brush__extra_size;
        uint64_t data_mask__extra_size;
        { /* brush */
            SPICE_GNUC_UNUSED uint8_t *start3 = (start2 + 0);
            uint64_t data_brush_u__nw_size, data_brush_u__extra_size;
            uint8_t type__value;
            { /* u */
                pos = start3 + 0;
                if (SPICE_UNLIKELY(pos + 1 > message_end)) {
                ...
                if (type__value == SPICE_BRUSH_TYPE_SOLID) {
                    ...
                    SPICE_GNUC_UNUSED uint8_t *start4 = (start3 + 1);
                    uint64_t data_brush_u_pat__extra_size;
                    { /* pat */
                        uint32_t pat__value;
                        pos = (start4 + 0);
                        if (SPICE_UNLIKELY(pos + 4 > message_end)) {
                        ...
                        ptr_size = validate_SpiceImage(message_start, message_end, pat__value);
                        if (SPICE_UNLIKELY(ptr_size < 0)) {
                            goto error;
                        }
        ...
        { /* mask */
            ...
            uint64_t data_mask_bitmap__extra_size;
            { /* bitmap */
                ...
                ptr_size = validate_SpiceImage(message_start, message_end, bitmap__value);
                if (SPICE_UNLIKELY(ptr_size < 0)) {
                    goto error;
                }
...
static uint8_t * parse_msg_display_draw_opaque(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    { /* data */
        SPICE_GNUC_UNUSED uint8_t *start2 = (start + 0 + base__nw_size);
        uint64_t data_src_bitmap__extra_size;
        uint64_t data_brush__nw_size, data_brush__extra_size;
        uint64_t data_mask__extra_size;
        { /* src_bitmap */
            ...
            ptr_size = validate_SpiceImage(message_start, message_end, src_bitmap__value);
            if (SPICE_UNLIKELY(ptr_size < 0)) {
                goto error;
            }
...
static uint8_t * parse_msg_display_draw_copy(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_draw_blend(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_draw_blackness(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_draw_whiteness(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_draw_invers(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_draw_rop3(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static intptr_t validate_SpicePath(uint8_t *message_start, uint8_t *message_end, uint64_t offset)
{
    uint8_t *start = message_start + offset;
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint64_t mem_size, nw_size;
    uint64_t segments__nw_size, segments__mem_size;
    uint64_t segments__nelements;
    uint32_t i;
    ...
    { /* segments */
        ...
        uint64_t segments__element__nw_size;
        uint64_t segments__element__mem_size;
        pos = start + 0;
        if (SPICE_UNLIKELY(pos + 4 > message_end)) {
            goto error;
        }
        ...
        for (i = 0; i < segments__nelements; i++) {
            ...
            uint64_t segments__element_points__nw_size, segments__element_points__mem_size;
            uint64_t segments__element_points__nelements;
            { /* points */
...
static uint8_t * parse_struct_SpicePath(uint8_t *message_start, SPICE_GNUC_UNUSED uint8_t *message_end, uint8_t *struct_data, PointerInfo *this_ptr_info)
{
    uint8_t *in = message_start + this_ptr_info->offset;
    uint8_t *end;
    SpicePath *out;
...
static uint8_t * parse_array_int32(uint8_t *message_start, SPICE_GNUC_UNUSED uint8_t *message_end, uint8_t *struct_data, PointerInfo *this_ptr_info)
{
    uint8_t *in = message_start + this_ptr_info->offset;
    uint8_t *end;
    uint32_t i;
...
static uint8_t * parse_msg_display_draw_stroke(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    { /* data */
        SPICE_GNUC_UNUSED uint8_t *start2 = (start + 0 + base__nw_size);
        uint64_t data_path__extra_size;
        uint64_t data_attr__nw_size, data_attr__extra_size;
        uint64_t data_brush__nw_size, data_brush__extra_size;
        { /* path */
            ...
            ptr_size = validate_SpicePath(message_start, message_end, path__value);
            if (SPICE_UNLIKELY(ptr_size < 0)) {
                goto error;
            }
        ...
        { /* attr */
            ...
            uint64_t data_attr_u1__nw_size;
            uint8_t flags__value;
            uint64_t data_attr_u2__nw_size, data_attr_u2__extra_size;
            { /* u1 */
                pos = start3 + 0;
                if (SPICE_UNLIKELY(pos + 1 > message_end)) {
                    goto error;
            ...
            { /* u2 */
                uint64_t data_attr_u2__array__nelements;
                pos = start3 + 0;
                if (SPICE_UNLIKELY(pos + 1 > message_end)) {
                    goto error;
                }
                ...
                if ((flags__value & SPICE_LINE_FLAGS_STYLED)) {
                    ...
                    uint64_t data_attr_u2__array__nw_size;
                    uint64_t data_attr_u2__array__mem_size;
                    ...
                    if (SPICE_UNLIKELY(data_attr_u2_style__value >= (uintptr_t) (message_end - message_start))) {
                        goto error;
                    }
                    pos = start3 + 1;
                    if (SPICE_UNLIKELY(pos + 1 > message_end)) {
                    ...
                    if (SPICE_UNLIKELY(data_attr_u2_style__value + data_attr_u2__array__nw_size > (uintptr_t) (message_end - message_start))) {
                        goto error;
                    }
    ...
    /* data */ {
        ...
        /* attr */ {
            ...
            if ((out->data.attr.flags & SPICE_LINE_FLAGS_STYLED)) {
                uint64_t style__array__nelements;
                ptr_info[n_ptr].offset = consume_uint32(&in);
...
static intptr_t validate_SpiceString(uint8_t *message_start, uint8_t *message_end, uint64_t offset)
{
    uint8_t *start = message_start + offset;
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint64_t mem_size, nw_size;
    ...
    { /* u */
        uint64_t u__mem_size;
        uint64_t u__nelements;
        pos = start + 2;
        if (SPICE_UNLIKELY(pos + 1 > message_end)) {
            goto error;
        }
        ...
        if ((flags__value & SPICE_STRING_FLAGS_RASTER_A1)) {
            ...
            uint64_t u__element__nw_size;
            uint64_t u__element__mem_size;
            pos = start + 0;
            if (SPICE_UNLIKELY(pos + 2 > message_end)) {
                goto error;
            }
            ...
            for (i = 0; i < u__nelements; i++) {
                SPICE_GNUC_UNUSED uint8_t *start3 = start2;
                uint64_t u__element_data__nw_size, u__element_data__mem_size;
                uint64_t u__element_data__nelements;
                { /* data */
                    ...
                    u__element_data__nelements = (((uint64_t) width__value + 7U) / 8U ) * height__value;
            ...
            for (i = 0; i < u__nelements; i++) {
                ...
                { /* data */
                    ...
                    height__value = read_uint16(pos);
                    u__element_data__nelements = ((4U * (uint64_t) width__value + 7U) / 8U ) * height__value;
            ...
            for (i = 0; i < u__nelements; i++) {
                ...
                { /* data */
                    ...
                    height__value = read_uint16(pos);
                    u__element_data__nelements = (uint64_t) width__value * height__value;
...
static uint8_t * parse_struct_SpiceString(uint8_t *message_start, SPICE_GNUC_UNUSED uint8_t *message_end, uint8_t *struct_data, PointerInfo *this_ptr_info)
{
    uint8_t *in = message_start + this_ptr_info->offset;
    uint8_t *end;
    SpiceString *out;
...
static uint8_t * parse_msg_display_draw_text(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    { /* data */
        SPICE_GNUC_UNUSED uint8_t *start2 = (start + 0 + base__nw_size);
        uint64_t data_str__extra_size;
        uint64_t data_fore_brush__nw_size, data_fore_brush__extra_size;
        uint64_t data_back_brush__nw_size, data_back_brush__extra_size;
        { /* str */
            uint32_t str__value;
            pos = (start2 + 0);
            if (SPICE_UNLIKELY(pos + 4 > message_end)) {
            ...
            ptr_size = validate_SpiceString(message_start, message_end, str__value);
            if (SPICE_UNLIKELY(ptr_size < 0)) {
                goto error;
            }
        ...
        { /* fore_brush */
            SPICE_GNUC_UNUSED uint8_t *start3 = (start2 + 20);
            uint64_t data_fore_brush_u__nw_size, data_fore_brush_u__extra_size;
            uint8_t type__value;
            { /* u */
                pos = start3 + 0;
                if (SPICE_UNLIKELY(pos + 1 > message_end)) {
                ...
                if (type__value == SPICE_BRUSH_TYPE_SOLID) {
                    ...
                    SPICE_GNUC_UNUSED uint8_t *start4 = (start3 + 1);
                    uint64_t data_fore_brush_u_pat__extra_size;
                    { /* pat */
                        uint32_t pat__value;
                        pos = (start4 + 0);
                        if (SPICE_UNLIKELY(pos + 4 > message_end)) {
        ...
        { /* back_brush */
            ...
            uint64_t data_back_brush_u__nw_size, data_back_brush_u__extra_size;
            uint8_t type__value;
            { /* u */
                pos = start3 + 0;
                if (SPICE_UNLIKELY(pos + 1 > message_end)) {
                ...
                if (type__value == SPICE_BRUSH_TYPE_SOLID) {
                    ...
                    SPICE_GNUC_UNUSED uint8_t *start4 = (start3 + 1);
                    uint64_t data_back_brush_u_pat__extra_size;
                    { /* pat */
                        uint32_t pat__value;
                        pos = (start4 + 0);
                        if (SPICE_UNLIKELY(pos + 4 > message_end)) {
...
static uint8_t * parse_msg_display_draw_transparent(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_draw_alpha_blend(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_surface_create(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_surface_destroy(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_stream_data_sized(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_monitors_config(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint64_t mem_size;
    uint8_t *in, *end;
    uint64_t heads__nw_size, heads__mem_size;
    uint64_t heads__nelements;
    ...
    for (i = 0; i < heads__nelements; i++) {
        ...
        out2->monitor_id = consume_uint32(&in);
...
static uint8_t * parse_msg_display_draw_composite(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    { /* data */
        SPICE_GNUC_UNUSED uint8_t *start2 = (start + 0 + base__nw_size);
        uint64_t data_src_bitmap__extra_size;
        uint64_t data_a__nw_size, data_a__extra_size;
        uint32_t flags__value;
        uint64_t data_b__nw_size;
        uint64_t data_c__nw_size;
        { /* src_bitmap */
            uint32_t src_bitmap__value;
            pos = (start2 + 4);
            if (SPICE_UNLIKELY(pos + 4 > message_end)) {
        ...
        { /* a */
            ...
            if ((flags__value & SPICE_COMPOSITE_HAS_MASK)) {
                ...
                ptr_size = validate_SpiceImage(message_start, message_end, data_a_mask_bitmap__value);
                if (SPICE_UNLIKELY(ptr_size < 0)) {
                    goto error;
                }
...
static uint8_t * parse_msg_display_stream_activate_report(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_gl_scanout_unix(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_display_gl_draw(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_inputs_init(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_inputs_key_modifiers(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_cursor_init(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_cursor_set(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_cursor_move(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_cursor_trail(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_cursor_inval_one(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_playback_data(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_playback_mode(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_playback_start(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_SpiceMsgAudioVolume(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint64_t mem_size;
    uint8_t *in, *end;
    uint64_t volume__nw_size, volume__mem_size;
    uint64_t volume__nelements;
...
static uint8_t * parse_SpiceMsgAudioMute(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_playback_latency(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_record_start(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_smartcard_data(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
...
static uint8_t * parse_msg_port_init(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    uint32_t n_ptr=0;
    PointerInfo ptr_info[1];
    uint64_t name__extra_size;
    uint64_t name__array__nelements;
    SpiceMsgPortInit *out;
    uint32_t i;

    { /* name */
        uint32_t name__value;
        uint64_t name__array__nw_size;
        uint64_t name__array__mem_size;
        ...
        if (SPICE_UNLIKELY(name__value >= (uintptr_t) (message_end - message_start))) {
            goto error;
        }
        pos = start + 0;
        if (SPICE_UNLIKELY(pos + 4 > message_end)) {
        ...
        if (SPICE_UNLIKELY(name__value + name__array__nw_size > (uintptr_t) (message_end - message_start))) {
            goto error;
        }
...
static uint8_t * parse_msg_port_event(uint8_t *message_start, uint8_t *message_end, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
